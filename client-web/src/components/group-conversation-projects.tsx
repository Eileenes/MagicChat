  ...
  return (
    <div className="group/project flex min-w-0 items-center gap-3 rounded-md px-2 py-1.5 text-sm hover:bg-muted">
      ...
      <div className="min-w-0 flex-1">
        <Link
          className="block w-fit max-w-full truncate transition-colors group-hover/project:text-(--weui-link) focus-visible:text-(--weui-link) focus-visible:outline-none"
